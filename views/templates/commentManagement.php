    ...
    <tbody>
        ...
        foreach ($comments as $comment) { 
            ...
            <tr class="tableLine <?php echo (($i%2 == 0) ? 'lignePaire' : 'ligneImpaire'); ?>" >
                ...
                <td>
                    <div>   
                        <a class="submit" href="index.php?action=deleteComment&id=<?= $comment->getId() ?>" <?= Utils::askConfirmation("Êtes-vous sûr de vouloir supprimer ce commentaire ?") ?> >Supprimer</a></div>
                    </div> 
                </td>
            </tr>
        <?php } ?>
